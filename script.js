  ...
  if (contactForm) {
    contactForm.addEventListener('submit', function(e) {
      ...
      contactForm.querySelectorAll('input, textarea, select').forEach(function(field) {
        ...
        if (field.hasAttribute('minlength') && fieldValue) {
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "חידון העם משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var response = await fetch(apiBase + '/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '9abb7bc8-87ac-4e31-9aee-2ffff07a8a6a',
                    name: data.name || '',
                    email: data.email || '',
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '9abb7bc8-87ac-4e31-9aee-2ffff07a8a6a';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '9abb7bc8-87ac-4e31-9aee-2ffff07a8a6a';
